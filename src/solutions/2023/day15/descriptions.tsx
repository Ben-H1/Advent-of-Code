...
export const part1Description = (<>
    ...
    <p>As you step inside, you are immediately greeted by a somewhat panicked <Hidden content='do you like my hard hat'>reindeer</Hidden> wearing goggles and a loose-fitting <Link link='https://en.wikipedia.org/wiki/Hard_hat'>hard hat</Link>. The reindeer leads you to a shelf of goggles and hard hats (you quickly find some that fit) and then further into the facility. At one point, you pass a button with a faint snout mark and the label "PUSH FOR HELP". No wonder you were loaded into that <Link link='https://adventofcode.com/2023/day/1'>trebuchet</Link> so quickly!</p><br/>
