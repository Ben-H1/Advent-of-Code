...
const givenInput = `L77FF.FJF|FL-7F7FF-F7F7FL.|.F-77.F--|.J7.FFLL--|7-7.7-L77F7-7.F-7F7-FF7F|77.|-JF7-FFF.L-7FFF7---|F7.|.FLF-JF-|-7---|F77FF-F-77FL77|-77.|-J.F
...
export const inputs = {
    ...
    part2: {
        exampleInput: part2ExampleInputs,
        givenInput
    }
};
